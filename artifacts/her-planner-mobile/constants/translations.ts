...
export const T: Record<string, TR> = {
  ...
  workHours:       { en: "WORK HOURS",         es: "HORAS DE TRABAJO",      pt: "HORAS DE TRABALHO"    },
  workHoursSub:    { en: "About how many hours do you work most days?", es: "¿Cuántas horas trabajas la mayoría de los días?", pt: "Quantas horas você trabalha na maioria dos dias?" },
  exercise:        { en: "EXERCISE",           es: "EJERCICIO",             pt: "EXERCÍCIO"            },
  exerciseSub:     { en: "How often and how intense is your typical exercise?", es: "¿Con qué frecuencia y qué tan intenso es tu ejercicio típico?", pt: "Com que frequência e intensidade é seu exercício típico?" },
  exerciseFreq:    { en: "Frequency",          es: "Frecuencia",            pt: "Frequência"           },
  exerciseIntensity:{ en: "Intensity",         es: "Intensidad",            pt: "Intensidade"          },
  exerciseNone:    { en: "None",               es: "Nada",                  pt: "Nenhum"               },
  exerciseLight:   { en: "Light",              es: "Suave",                 pt: "Leve"                 },
  exerciseModerate:{ en: "Moderate",           es: "Moderado",              pt: "Moderado"             },
  exerciseHard:    { en: "Hard",               es: "Intense",               pt: "Intenso"              },
  exerciseTimes:   { en: "{n}x/week",          es: "{n}x/semana",           pt: "{n}x/semana"          },
  contraception:   { en: "CONTRACEPTION",      es: "ANTICONCEPTIVO",        pt: "ANTICONCEPCIONAL"     },
  contraceptionSub:{ en: "Optional — helps Luna tailor cycle and symptom advice.", es: "Opcional — ayuda a Luna a personalizar el ciclo y los síntomas.", pt: "Opcional — ajuda Luna a adaptar dicas de ciclo e sintomas." },
  contraceptionNone:{ en: "None",              es: "Ninguno",               pt: "Nenhum"               },
  contraceptionPill:{ en: "Pill",              es: "Píldora",               pt: "Pílula"               },
  contraceptionIud:{ en: "IUD",                es: "DIU",                   pt: "DIU"                  },
  contraceptionPatch:{ en: "Patch",            es: "Parche",                pt: "Adesivo"              },
  contraceptionRing:{ en: "Ring",              es: "Anillo",                pt: "Anel"                 },
  contraceptionShot:{ en: "Shot",              es: "Inyección",             pt: "Injeção"              },
  contraceptionOther:{ en: "Other",            es: "Otro",                  pt: "Outro"                },
  contraceptionUnknown:{ en: "Prefer not to say", es: "Prefiero no decirlo", pt: "Prefiro não dizer" },
  sleepHours:      { en: "SLEEP",              es: "SUEÑO",                 pt: "SONO"                 },
  sleepHoursSub:   { en: "Average hours you sleep on a typical night", es: "Horas promedio que duermes en una noche normal", pt: "Horas médias que você dorme numa noite normal" },
  hydration:       { en: "HYDRATION",          es: "HIDRATACIÓN",           pt: "HIDRATAÇÃO"           },
  hydrationSub:    { en: "How much water do you usually drink?", es: "¿Cuánta agua sueles beber?", pt: "Quanta água você costuma beber?" },
  waterLow:        { en: "Low",               es: "Baja",                  pt: "Baixa"                },
  waterMedium:     { en: "Okay",              es: "Normal",                pt: "Ok"                   },
  waterHigh:       { en: "High",              es: "Alta",                  pt: "Alta"                 },
